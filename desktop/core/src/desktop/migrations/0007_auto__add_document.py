...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('desktop_document', (
            ('status', self.gf('django.db.models.fields.TextField')(default='active')),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 16, 36, 17, 558571)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 16, 36, 17, 558506)'}),
